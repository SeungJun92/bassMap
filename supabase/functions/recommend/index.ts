...
2. **주소 정밀도:** 주소를 '장성읍 용강리'처럼 뭉뚱그리지 마세요. 반드시 **'장성읍 용강리 123-4'**와 같이 **상세 지번(번지수) 또는 도로명 번호**가 포함된 전체 주소를 검색해서 제공해야 합니다.
3. **데이터 일치:** 모든 포인트는 '장성 맑은물 오토캠핑장'과 같이 실제 명칭과 상세 주소가 검색 결과와 100% 일치해야 합니다.
4. **수변 좌표:** 모든 위도/경도는 반드시 해당 상세 주소의 **물가 바로 앞**이어야 합니다.
